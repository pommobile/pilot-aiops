...
curl -X PATCH "https://dev294930.service-now.com/api/now/table/incident/$snsi" --user 'admin:c10eQ=BVeDf*' --header 'Content-Type: application/json' --header 'Accept: application/json' --data "{ \"cause\": \"$cause\" }"
